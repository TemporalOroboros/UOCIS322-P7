...
def get_times(controle_dist_km, brevet_dist_km, brevet_start_time):
    ...
    """
    open_arrow = open_time(controle_dist_km, brevet_dist_km, brevet_start_time)
    close_arrow = close_time(controle_dist_km, brevet_dist_km, brevet_start_time)
    return open_arrow, close_arrow
